...
import { Autocomplete, Box, Card, CardContent, Paper, TextField, Typography } from "@mui/material";
import {   
  GridRowModes,
  DataGrid,
  GridActionsCellItem,
      ...
      <div className="flex flex-col md:flex-row gap-6 p-6 max-w-7xl mx-auto w-full">
        ...
        <div className="w-full md:w-1/3 flex flex-col gap-6">
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            {/* Masraf Kartı */}
            {!isLoading &&infoRapor.masraf>0&& (<Card
              sx={{ 
            ...
            {/* Net Kazanç Kartı */}
            {!isLoading &&( infoRapor?.aracgiriskazanci >0 || infoRapor?.masraf) >0 &&(<Card 
              sx={{ 
            ...
            >
              <CardContent>
                ...
                <Typography variant="h4" sx={{ color: '#1a237e', fontWeight: 700 }}>
                  {infoRapor.aracgiriskazanci - infoRapor.masraf} ₺
                </Typography>
        ...
        {/* Sağ Panel - Rapor Tablosu */}
        <div className="w-full md:w-2/3">
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          <div className="flex justify-between p-4 border-b">
            <h2 className="text-xl text-start font-semibold text-gray-800">Aylık Araç Giriş Raporu</h2>
          </div>

          <div className="overflow-x-auto">
            {isLoading===true ? (
              <div className="flex flex-col justify-center items-center m-25 p-3 h-full">
